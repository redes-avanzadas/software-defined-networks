...
Fue originalmente implementado por la Universidad de Stanford con el fin de permitir la creación de protocolos experimentales en las redes dentro del campus que pudieran ser usados para la investigación debido a que los estudiantes tenían que crear sus propios ambientes de redes desde cero.
...
\bibitem{slattery}
Network Startup Resource Center. \emph{Introduccion a OpenFlow}. Disponible en \url{https://nsrc.org/workshops/2015/walc/routing/raw-attachment/wiki/Agenda/15-Introducci\%C3\%B3n-SDN-Openflow.pdf}

\bibitem{slattery}
M.~McNickle. \emph{Cinco protocolos SDN que no son OpenFlow}.\hskip 1em plus 0.5em minus 0.4em\relax TechTarget.
